...
DROP TABLE islands;
CREATE TABLE islands(`id` INTEGER PRIMARY KEY AUTOINCREMENT, `name` VARCHAR(190), `home` VARCHAR, `visit` BOOLEAN, `create_time` BIGINT, `experience` INTEGER, `color` VARCHAR NOT NULL,  UNIQUE (`name`));
