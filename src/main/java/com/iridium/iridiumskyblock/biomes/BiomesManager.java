...
public class BiomesManager {
     ...
     * They might not have enough money to do so.
     *
    ...
    public void buy(Player player, BiomeItem biomeItem) {
        ...
        final Optional<XBiome> biomeOptional = XBiome.matchXBiome(biomeItem.getBiome().toString());
     ...
     */
    private double calculateCost(int defaultAmount, double defaultPrice) {
        double costPerItem = defaultPrice / defaultAmount;
        return round(costPerItem, 2);
    }
