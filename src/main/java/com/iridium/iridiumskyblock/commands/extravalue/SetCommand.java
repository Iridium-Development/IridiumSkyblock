...
public class SetCommand extends Command {
     ...
     */
    public SetCommand() {
        super(Collections.singletonList("set"), "Set the extra value of a player", "%prefix% &7/is extravalue set <player> <amount>", "iridiumskyblock.extravalue", false, Duration.ZERO);
    }
