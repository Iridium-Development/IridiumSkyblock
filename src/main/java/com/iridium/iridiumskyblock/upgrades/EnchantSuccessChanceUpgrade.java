...
@NoArgsConstructor
public class EnchantSuccessChanceUpgrade extends UpgradeData {
    public int amount;

    public EnchantSuccessChanceUpgrade(int money, int crystals, int mobcoins, int prestigeRequired, int size) {
