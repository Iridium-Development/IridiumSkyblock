...
public class BlockSpreadListener implements Listener {
    ...
    public void onBlockSpread(BlockSpreadEvent event) {
        IridiumSkyblock.getInstance().getIslandManager().getIslandViaLocation(event.getBlock().getLocation()).ifPresent(island -> {
            ...
            IslandSettingImpl switchSetting = IridiumSkyblock.getInstance().getSettingsList().get(IslandSettingType.FIRE_SPREAD.getSettingKey());
            IslandSetting islandSetting = IridiumSkyblock.getInstance().getIslandManager().getIslandSetting(island, IslandSettingType.FIRE_SPREAD.getSettingKey(), switchSetting.getDefaultValue());
