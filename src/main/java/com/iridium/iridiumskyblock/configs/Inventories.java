...
public class Inventories {
    ...
    public Item islandMember = new Item(XMaterial.PLAYER_HEAD, 0, 1, "&b&l{player}", "{player}", Arrays.asList("&7Joined: {time}", "", "&b&l[!] &7Right Click to promote", "&b&l[!] &7Left click to demote/kick"));
}
