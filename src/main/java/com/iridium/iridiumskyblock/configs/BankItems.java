...
public class BankItems {
    ...
    public MobCoinsBankItem mobcoinsBankItem = new MobCoinsBankItem(10, new Item(XMaterial.GOLD_NUGGET, 11, 1, "&e&lIsland Mob Coins", Arrays.asList("&7$%amount%", "&b&l[!] &bLeft click to withdraw", "&b&l[!] &bRight click to deposit")));
