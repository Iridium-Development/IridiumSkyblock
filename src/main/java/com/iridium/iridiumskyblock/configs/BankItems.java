...
public class BankItems {
    ...
    public MoneyBankItem moneyBankItem = new MoneyBankItem(100, new Item(XMaterial.PAPER, 11, 1, "&b&lIsland Money", Arrays.asList("&7$%amount%", "&b&l[!] &bLeft click to withdraw", "&b&l[!] &bRight click to deposit")));
