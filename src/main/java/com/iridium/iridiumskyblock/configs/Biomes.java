...
public class Biomes {
    ...
    public Map<String, BiomeCategoryConfig> categories = ImmutableMap.<String, BiomeCategoryConfig>builder()
            .put("Overworld", new BiomeCategoryConfig(new Item(XMaterial.GRASS_BLOCK, 12, 1, "&9&lOverworld", Collections.emptyList()), 6))
            .put("Nether", new BiomeCategoryConfig(new Item(XMaterial.CRIMSON_HYPHAE, 14, 1, "&9&lNether", Collections.emptyList()), 6))
            .put("End", new BiomeCategoryConfig(new Item(XMaterial.END_STONE, 16, 1, "&9&lEnd", Collections.emptyList()), 6))
            .build();
