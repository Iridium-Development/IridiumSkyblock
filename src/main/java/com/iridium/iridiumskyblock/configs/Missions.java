...
public class Missions {
    ...
    public Map<String, Mission> missions = ImmutableMap.<String, Mission>builder()
            ...
            .put("potionbrewer", new Mission(new Item(XMaterial.POTION, 1, "&b&lPotion Brewer", Arrays.asList("&7Complete Island Missions to gain rewards", "&7Which can be used to purchase Island Upgrades", "", "&b&lObjectives:", "&b&l* &7Brew 15 Potions: %progress_1%/10", "", "&b&lRewards", "&b&l* &72 Island Crystals", "&b&l* &7$1000")), Collections.singletonList("BREW:ANY:15"), Mission.MissionType.DAILY))
