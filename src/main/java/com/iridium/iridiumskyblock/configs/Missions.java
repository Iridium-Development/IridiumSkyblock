...
public class Missions {
    ...
    public Map<String, Mission> missions = ImmutableMap.<String, Mission>builder()
            .put("farmer", new Mission(new Item(XMaterial.SUGAR_CANE, 1, "&b&lFarmer", Arrays.asList("&7Complete Island Missions to gain rewards", "&7Which can be used to purchase Island Upgrades", "", "&b&lObjectives:", "&b&l* &7Grow 10 Sugarcane: %progress_1%/10", "&b&l* &7Grow 10 Wheat: %progress_2%/10", "&b&l* &7Grow 10 Carrots: %progress_3%/10", "", "&b&lRewards", "&b&l* &72 Island Crystals", "&b&l* &7$1000")), Arrays.asList("GROW:SUGAR_CANE:10", "GROW:WHEAT:10", "GROW:CARROTS:10"), Mission.MissionType.DAILY))
            ...
            .put("baker", new Mission(new Item(XMaterial.BREAD, 1, "&b&lBaker", Arrays.asList("&7Complete Island Missions to gain rewards", "&7Which can be used to purchase Island Upgrades", "", "&b&lObjectives:", "&b&l* &7Bake 64 Bread: %progress_1%/64", "", "&b&lRewards", "&b&l* &72 Island Crystals", "&b&l* &7$1000")), Collections.singletonList("CRAFT:BREAD:64"), Mission.MissionType.DAILY))
            .put("miner", new Mission(new Item(XMaterial.GOLD_ORE, 1, "&b&lMiner", Arrays.asList("&7Complete Island Missions to gain rewards", "&7Which can be used to purchase Island Upgrades", "", "&b&lObjectives:", "&b&l* &7Mine 15 Iron Ores: %progress_1%/15", "&b&l* &7Mine 30 Coal Ores: %progress_2%/30", "&b&l* &7Mine 1 Diamond Ore: %progress_3%/1", "", "&b&lRewards", "&b&l* &72 Island Crystals", "&b&l* &7$1000")), Arrays.asList("MINE:IRON_ORE:15", "MINE:COAL_ORE:30", "MINE:DIAMOND_ORE:1"), Mission.MissionType.DAILY))
            ...
            .put("blacksmith", new Mission(new Item(XMaterial.IRON_INGOT, 1, "&b&lBlacksmith", Arrays.asList("&7Complete Island Missions to gain rewards", "&7Which can be used to purchase Island Upgrades", "", "&b&lObjectives:", "&b&l* &7Smelt 30 Iron Ores: %progress_1%/30", "&b&l* &7Smelt 15 Gold Ores: %progress_3%/15", "", "&b&lRewards", "&b&l* &72 Island Crystals", "&b&l* &7$1000")), Arrays.asList("SMELT:IRON_ORE:30", "SMELT:GOLD_ORE:15"), Mission.MissionType.DAILY))
            ...
            .put("lumberjack", new Mission(new Item(XMaterial.OAK_LOG, 1, "&b&lLumberJack", Arrays.asList("&7Complete Island Missions to gain rewards", "&7Which can be used to purchase Island Upgrades", "", "&b&lObjectives:", "&b&l* &7Collect 32 Logs: %progress_1%/32", "", "&b&lRewards", "&b&l* &72 Island Crystals", "&b&l* &7$1000")), Collections.singletonList("COLLECT:LOG:32"), Mission.MissionType.DAILY))
            .build();
