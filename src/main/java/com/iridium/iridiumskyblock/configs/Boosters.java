...
public class Boosters {
    ...
    public Booster farmingBooster = new Booster(new Item(IridiumMaterial.WHEAT, 10, 1, "&b&lFarming Booster", Arrays.asList(
    ...
    public Booster spawnerBooster = new Booster(new Item(IridiumMaterial.SPAWNER, 12, 1, "&b&lSpawner Booster", Arrays.asList(
    ...
    public Booster experienceBooster = new Booster(new Item(IridiumMaterial.EXPERIENCE_BOTTLE, 14, 1, "&b&lExperience Booster", Arrays.asList(
    ...
    public Booster flightBooster = new Booster(new Item(IridiumMaterial.FEATHER, 16, 1, "&b&lFlight Booster", Arrays.asList(
