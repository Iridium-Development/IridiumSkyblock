...
public class Boosters {
    public Booster islandHopperBooster = new Booster(new Item(XMaterial.HOPPER, 11, 1, "&b&lHopper Upgrade", Arrays.asList(
    ...
    public Booster islandFarmingBooster = new Booster(new Item(XMaterial.WHEAT, 12, 1, "&b&lFarming Upgrade", Arrays.asList(
            "&7Crops growing too slow? Buy this",
            "&7booster and increase growth rates x2.",
            "",
            "&b&lInformation:",
            "&b&l * &7Time Remaining: &b%timeremaining_minutes% minutes and %timeremaining_seconds%seconds",
            "&b&l * &7Booster Cost: &b%crystalcost% Crystals and $%vaultcost%",
    ...
    public Booster islandSpawnerBooster = new Booster(new Item(XMaterial.SPAWNER, 13, 1, "&b&lSpawner Upgrade", Arrays.asList(
    ...
    public Booster islandFlightBooster = new Booster(new Item(XMaterial.FEATHER, 15, 1, "&b&lFlight Upgrade", Arrays.asList(
