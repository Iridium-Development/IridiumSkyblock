...
public class Inventories {
    ...
    public LogInventoryConfig logsGUI = new LogInventoryConfig(27, "&7Island Logs",
            new Item(XMaterial.PLAYER_HEAD, 10, 1, "&b&lIsland Members", "%island_owner%", Arrays.asList("&7page %current_page%/%max_page%", "")),
            new Item(XMaterial.EMERALD, 11, 1, "&b&lIsland Trusts", Arrays.asList("&7page %current_page%/%max_page%", "")),
            new Item(XMaterial.LAPIS_LAZULI, 12, 1, "&b&lIsland Invites", Arrays.asList("&7page %current_page%/%max_page%", "")),
            new Item(XMaterial.GOLD_INGOT, 13, 1, "&b&lIsland Bank", Arrays.asList("&7page %current_page%/%max_page%", "")),
            new Item(XMaterial.EXPERIENCE_BOTTLE, 14, 1, "&b&lIsland Boosters", Arrays.asList("&7page %current_page%/%max_page%", "")),
            new Item(XMaterial.BEACON, 15, 1, "&b&lIsland Upgrades", Arrays.asList("&7page %current_page%/%max_page%", "")),
            new Item(XMaterial.DIAMOND, 16, 1, "&b&lIsland Rewards", Arrays.asList("&7page %current_page%/%max_page%", "")),
